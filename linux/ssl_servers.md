...
<br>Дальше настроили SSL-сертификат на веб-сервере Битрикс.
...
<br>Настраивается несложно через веб-интерфейс. Для установки предварительная подготовка файлов не требуется. Порядок установки такой:
...
<br>Так как сервер доступен через обратный прокси из мира, то находим мануал на портале Atlassian для нашего случая.
...
Вот в кратком описании и все действия по настройке SSL для веб-серверов.
